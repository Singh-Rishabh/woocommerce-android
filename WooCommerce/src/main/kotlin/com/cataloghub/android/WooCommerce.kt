...
import com.cataloghub.android.extensions.getCurrentProcessName
...
open class WooCommerce : Application(), HasAndroidInjector, Configuration.Provider {
    ...
    override fun onCreate() {
        ...
        //  > com.cataloghub.android:stripelocalmobile Make sure to call FirebaseApp.initializeApp(Context) first.
