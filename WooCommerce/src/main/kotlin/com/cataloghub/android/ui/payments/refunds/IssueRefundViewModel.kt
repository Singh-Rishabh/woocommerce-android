...
import com.cataloghub.android.analytics.AnalyticsEvent.CREATE_ORDER_REFUND_ITEM_QUANTITY_DIALOG_OPENED
import com.cataloghub.android.analytics.AnalyticsEvent.CREATE_ORDER_REFUND_NEXT_BUTTON_TAPPED
import com.cataloghub.android.analytics.AnalyticsEvent.CREATE_ORDER_REFUND_SELECT_ALL_ITEMS_BUTTON_TAPPED
import com.cataloghub.android.analytics.AnalyticsEvent.CREATE_ORDER_REFUND_SUMMARY_REFUND_BUTTON_TAPPED
import com.cataloghub.android.analytics.AnalyticsEvent.ORDER_NOTE_ADD_FAILED
import com.cataloghub.android.analytics.AnalyticsEvent.ORDER_NOTE_ADD_SUCCESS
import com.cataloghub.android.analytics.AnalyticsEvent.REFUND_CREATE
import com.cataloghub.android.analytics.AnalyticsEvent.REFUND_CREATE_FAILED
import com.cataloghub.android.analytics.AnalyticsEvent.REFUND_CREATE_SUCCESS
...
import com.cataloghub.android.extensions.calculateTotalSubtotal
import com.cataloghub.android.extensions.calculateTotalTaxes
...
import com.cataloghub.android.extensions.joinToString
...
import com.cataloghub.android.model.PaymentGateway
import com.cataloghub.android.model.Refund
import com.cataloghub.android.model.getMaxRefundQuantities
...
import com.cataloghub.android.ui.payments.refunds.IssueRefundViewModel.InputValidationState.TOO_HIGH
import com.cataloghub.android.ui.payments.refunds.IssueRefundViewModel.InputValidationState.TOO_LOW
import com.cataloghub.android.ui.payments.refunds.IssueRefundViewModel.InputValidationState.VALID
import com.cataloghub.android.ui.payments.refunds.IssueRefundViewModel.IssueRefundEvent.HideValidationError
import com.cataloghub.android.ui.payments.refunds.IssueRefundViewModel.IssueRefundEvent.OpenUrl
import com.cataloghub.android.ui.payments.refunds.IssueRefundViewModel.IssueRefundEvent.ShowNumberPicker
...
import com.cataloghub.android.ui.payments.refunds.IssueRefundViewModel.RefundType.AMOUNT
import com.cataloghub.android.ui.payments.refunds.IssueRefundViewModel.RefundType.ITEMS
import com.cataloghub.android.ui.payments.refunds.RefundFeeListAdapter.FeeRefundListItem
import com.cataloghub.android.ui.payments.refunds.RefundProductListAdapter.ProductRefundListItem
import com.cataloghub.android.ui.payments.refunds.RefundShippingListAdapter.ShippingRefundListItem
import com.cataloghub.android.util.CoroutineDispatchers
import com.cataloghub.android.util.CurrencyFormatter
import com.cataloghub.android.util.max
import com.cataloghub.android.util.min
