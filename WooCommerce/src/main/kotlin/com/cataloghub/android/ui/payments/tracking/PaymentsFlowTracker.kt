...
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.KEY_IS_ENABLED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.KEY_PAYMENT_GATEWAY
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.KEY_POS_ONBOARDING_STATE
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.KEY_REASON
...
import com.cataloghub.android.cardreader.payments.CardInteracRefundStatus.RefundStatusErrorType
...
import com.cataloghub.android.ui.payments.cardreader.cardReaderBatteryLevelPercent
...
import com.cataloghub.android.ui.payments.hub.PaymentsHubViewModel.CashOnDeliverySource
...
class PaymentsFlowTracker @Inject constructor(
    ...
    private fun addPreferredPluginSlugProperty(properties: MutableMap<String, Any>) {
        ...
        properties["plugin_slug"] = when (preferredPlugin) {
            ...
            STRIPE_EXTENSION_GATEWAY -> "cataloghub-stripe"
            null -> "unknown"
        }
    }
    ...
    fun trackPaymentGatewaySelected(pluginType: PluginType) {
        val preferredPlugin = when (pluginType) {
            WOOCOMMERCE_PAYMENTS -> "cataloghub-payments"
            STRIPE_EXTENSION_GATEWAY -> "cataloghub-stripe-gateway"
        }
        track(
