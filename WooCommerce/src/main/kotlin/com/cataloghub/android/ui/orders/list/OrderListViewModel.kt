...
import com.cataloghub.android.analytics.AnalyticsEvent.ORDERS_LIST_AUTOMATIC_TIMEOUT_RETRY
import com.cataloghub.android.analytics.AnalyticsEvent.ORDERS_LIST_TOP_BANNER_TROUBLESHOOT_TAPPED
import com.cataloghub.android.analytics.AnalyticsEvent.ORDER_LIST_PRODUCT_BARCODE_SCANNING_TAPPED
...
import com.cataloghub.android.extensions.drop
import com.cataloghub.android.extensions.filter
...
import com.cataloghub.android.ui.orders.list.OrderListViewModel.OrderListEvent.RetryLoadingOrders
import com.cataloghub.android.ui.orders.list.OrderListViewModel.OrderListEvent.ShowErrorSnack
import com.cataloghub.android.ui.orders.list.OrderListViewModel.OrderListEvent.ShowOrderFilters
import com.cataloghub.android.util.CoroutineDispatchers
import com.cataloghub.android.util.DateUtils
import com.cataloghub.android.util.ThrottleLiveData
import com.cataloghub.android.util.WooLog
import com.cataloghub.android.util.WooLog.T.ORDERS
...
import com.cataloghub.android.widgets.WCEmptyView.EmptyViewType
...
class OrderListViewModel @Inject constructor(
     ...
     *  See https://github.com/cataloghub/cataloghub-android/issues/2621
     *
     */
