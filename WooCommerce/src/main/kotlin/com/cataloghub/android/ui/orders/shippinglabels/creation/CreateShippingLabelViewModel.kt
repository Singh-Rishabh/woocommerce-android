...
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.KEY_AMOUNT
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.KEY_FULFILL_ORDER
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.KEY_STATE
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.KEY_TOTAL_DURATION
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_CARRIER_RATES_SELECTED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_CARRIER_RATES_STARTED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_CUSTOMS_COMPLETE
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_CUSTOMS_STARTED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_DESTINATION_ADDRESS_COMPLETE
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_DESTINATION_ADDRESS_STARTED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_ORIGIN_ADDRESS_COMPLETE
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_ORIGIN_ADDRESS_STARTED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_PACKAGES_SELECTED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_PACKAGES_STARTED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_PAYMENT_METHOD_SELECTED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_PAYMENT_METHOD_STARTED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_PURCHASE_FAILED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_PURCHASE_INITIATED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_PURCHASE_READY
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_PURCHASE_SUCCEEDED
import com.cataloghub.android.analytics.AnalyticsTracker.Companion.VALUE_STARTED
import com.cataloghub.android.extensions.sumByBigDecimal
import com.cataloghub.android.extensions.sumByFloat
import com.cataloghub.android.model.Address
import com.cataloghub.android.model.CustomsPackage
import com.cataloghub.android.model.GetLocations
import com.cataloghub.android.model.Order
import com.cataloghub.android.model.PaymentMethod
import com.cataloghub.android.model.ShippingLabel
import com.cataloghub.android.model.ShippingLabelPackage
import com.cataloghub.android.model.ShippingRate
...
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelEvent.ShowAddressEditor
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelEvent.ShowCustomsForm
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelEvent.ShowPackageDetails
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelEvent.ShowPaymentDetails
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelEvent.ShowPrintShippingLabels
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelEvent.ShowShippingRates
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelEvent.ShowSuggestedAddress
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelEvent.ShowWooDiscountBottomSheet
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelViewModel.UiState.Failed
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelViewModel.UiState.Loading
import com.cataloghub.android.ui.orders.shippinglabels.creation.CreateShippingLabelViewModel.UiState.WaitingForInput
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelAddressValidator.AddressType
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelAddressValidator.AddressType.DESTINATION
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelAddressValidator.AddressType.ORIGIN
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelAddressValidator.ValidationResult
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Error
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Error.AddressValidationError
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Error.DataLoadingError
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Error.PackagesLoadingError
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Error.PurchaseError
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.AddressChangeSuggested
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.AddressEditCanceled
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.AddressInvalid
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.AddressValidated
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.AddressValidationFailed
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.CustomsDeclarationStarted
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.CustomsFormFilledOut
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.DataLoaded
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.DataLoadingFailed
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditAddressRequested
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditCustomsCanceled
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditCustomsRequested
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditOriginAddressRequested
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditPackagingCanceled
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditPackagingRequested
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditPaymentCanceled
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditPaymentRequested
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditShippingAddressRequested
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.EditShippingCarrierRequested
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.FlowStarted
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.OriginAddressValidationStarted
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.PackageSelectionStarted
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.PackagesSelected
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.PaymentSelected
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.PaymentSelectionStarted
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.PurchaseFailed
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.PurchaseStarted
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.PurchaseSuccess
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.ShippingAddressValidationStarted
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.ShippingCarrierSelected
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.ShippingCarrierSelectionCanceled
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.ShippingCarrierSelectionStarted
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.SuggestedAddressAccepted
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Event.SuggestedAddressDiscarded
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.SideEffect
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.State
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.StateMachineData
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Step
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Step.CarrierStep
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Step.CustomsStep
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Step.OriginAddressStep
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Step.PackagingStep
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Step.PaymentsStep
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.Step.ShippingAddressStep
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.StepStatus.DONE
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.StepStatus.NOT_READY
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.StepStatus.READY
import com.cataloghub.android.ui.orders.shippinglabels.creation.ShippingLabelsStateMachine.StepsState
import com.cataloghub.android.ui.orders.shippinglabels.creation.banner.CheckEUShippingScenario
