...
import com.cataloghub.android.AppPrefs.CardReaderOnboardingStatus.CARD_READER_ONBOARDING_NOT_COMPLETED
import com.cataloghub.android.AppPrefs.CardReaderOnboardingStatus.valueOf
import com.cataloghub.android.AppPrefs.DeletablePrefKey.BLAZE_CAMPAIGN_CREATED
import com.cataloghub.android.AppPrefs.DeletablePrefKey.CARD_READER_DO_NOT_SHOW_CASH_ON_DELIVERY_DISABLED_ONBOARDING_STATE
import com.cataloghub.android.AppPrefs.DeletablePrefKey.CARD_READER_IS_PLUGIN_EXPLICITLY_SELECTED
import com.cataloghub.android.AppPrefs.DeletablePrefKey.CARD_READER_ONBOARDING_COMPLETED_STATUS_V2
import com.cataloghub.android.AppPrefs.DeletablePrefKey.CARD_READER_PREFERRED_PLUGIN
import com.cataloghub.android.AppPrefs.DeletablePrefKey.CARD_READER_PREFERRED_PLUGIN_VERSION
import com.cataloghub.android.AppPrefs.DeletablePrefKey.CARD_READER_STATEMENT_DESCRIPTOR
import com.cataloghub.android.AppPrefs.DeletablePrefKey.CARD_READER_UPSELL_BANNER_DIALOG_DISMISSED_FOREVER
import com.cataloghub.android.AppPrefs.DeletablePrefKey.CARD_READER_UPSELL_BANNER_DIALOG_DISMISSED_REMIND_ME_LATER
import com.cataloghub.android.AppPrefs.DeletablePrefKey.DATABASE_DOWNGRADED
import com.cataloghub.android.AppPrefs.DeletablePrefKey.IMAGE_OPTIMIZE_ENABLED
import com.cataloghub.android.AppPrefs.DeletablePrefKey.ORDER_FILTER_CUSTOM_DATE_RANGE_END
import com.cataloghub.android.AppPrefs.DeletablePrefKey.ORDER_FILTER_CUSTOM_DATE_RANGE_START
import com.cataloghub.android.AppPrefs.DeletablePrefKey.ORDER_FILTER_PREFIX
import com.cataloghub.android.AppPrefs.DeletablePrefKey.PRODUCT_SORTING_PREFIX
import com.cataloghub.android.AppPrefs.DeletablePrefKey.RECEIPT_PREFIX
import com.cataloghub.android.AppPrefs.DeletablePrefKey.UPDATE_SIMULATED_READER_OPTION
import com.cataloghub.android.AppPrefs.DeletablePrefKey.WC_STORE_ID
import com.cataloghub.android.AppPrefs.DeletableSitePrefKey.AUTO_TAX_RATE_ID
import com.cataloghub.android.AppPrefs.UndeletablePrefKey.APPLICATION_STORE_SNAPSHOT_TRACKED_FOR_SITE
import com.cataloghub.android.AppPrefs.UndeletablePrefKey.ONBOARDING_CAROUSEL_DISPLAYED
import com.cataloghub.android.AppPrefs.UndeletablePrefKey.STORE_ONBOARDING_SHOWN_AT_LEAST_ONCE
import com.cataloghub.android.AppPrefs.UndeletablePrefKey.STORE_ONBOARDING_TASKS_COMPLETED
import com.cataloghub.android.AppPrefs.UndeletablePrefKey.STORE_PHONE_NUMBER
import com.cataloghub.android.extensions.orNullIfEmpty
import com.cataloghub.android.extensions.packageInfo
import com.cataloghub.android.notifications.NotificationChannelType
import com.cataloghub.android.tools.SelectedSite
import com.cataloghub.android.ui.payments.cardreader.onboarding.PersistentOnboardingData
import com.cataloghub.android.ui.payments.cardreader.onboarding.PluginType
import com.cataloghub.android.ui.prefs.developer.DeveloperOptionsViewModel.DeveloperOptionsViewState.UpdateFrequencyUiModel
import com.cataloghub.android.ui.prefs.domain.DomainFlowSource
import com.cataloghub.android.ui.products.ProductType
import com.cataloghub.android.ui.products.ai.AiTone
import com.cataloghub.android.ui.promobanner.PromoBannerType
import com.cataloghub.android.util.ThemeOption
import com.cataloghub.android.util.ThemeOption.DEFAULT
import com.cataloghub.commons.prefs.PreferenceUtils
