...
import com.cataloghub.android.analytics.AnalyticsEvent.REVIEW_OPEN
...
import com.cataloghub.android.model.FeatureAnnouncementItem
import com.cataloghub.android.notifications.NotificationChannelType
import com.cataloghub.android.notifications.UnseenReviewsCountHandler
import com.cataloghub.android.notifications.WooNotificationType
import com.cataloghub.android.notifications.push.NotificationMessageHandler
import com.cataloghub.android.notifications.push.NotificationTestUtils
...
import com.cataloghub.android.ui.moremenu.MoreMenuNewFeatureHandler
import com.cataloghub.android.ui.whatsnew.FeatureAnnouncementRepository
...
class MainActivityViewModelTest : BaseUnitTest() {
    ...
    fun `given payments shortcut, when app opened, then trigger ViewPayments event`() {
        testBlocking {
            ...
            // WHEN
            viewModel.handleShortcutAction("com.cataloghub.android.payments")
    ...
    fun `given order creation shortcut, when app opened, then trigger OpenOrderCreation event`() {
        testBlocking {
            ...
            // WHEN
            viewModel.handleShortcutAction("com.cataloghub.android.ordercreation")
    ...
    fun `given irrelevant shortcut, when app opened, then do not trigger any event`() {
        testBlocking {
            ...
            // WHEN
            viewModel.handleShortcutAction("com.cataloghub.android.irrelevant")
    ...
    fun `given image uris when app opened, then a product creation is triggered using the images`() = testBlocking {
        ...
        val uri = "content://com.cataloghub.android.fileprovider/cataloghub/woocommerce_1.jpg"
