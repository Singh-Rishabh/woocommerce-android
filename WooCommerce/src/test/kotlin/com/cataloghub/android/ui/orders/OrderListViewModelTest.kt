...
import com.cataloghub.android.extensions.NotificationReceivedEvent
...
import com.cataloghub.android.notifications.NotificationChannelsHandler
import com.cataloghub.android.notifications.NotificationChannelsHandler.NewOrderNotificationSoundStatus
import com.cataloghub.android.notifications.ShowTestNotification
...
import com.cataloghub.android.ui.orders.filters.domain.GetSelectedOrderFiltersCount
import com.cataloghub.android.ui.orders.filters.domain.GetWCOrderListDescriptorWithFilters
import com.cataloghub.android.ui.orders.filters.domain.GetWCOrderListDescriptorWithFiltersAndSearchQuery
import com.cataloghub.android.ui.orders.filters.domain.ShouldShowCreateTestOrderScreen
import com.cataloghub.android.ui.orders.list.BulkUpdateOrderResult
import com.cataloghub.android.ui.orders.list.FetchOrdersRepository
import com.cataloghub.android.ui.orders.list.ObserveOrdersListLastUpdate
import com.cataloghub.android.ui.orders.list.OrderListFragmentArgs
import com.cataloghub.android.ui.orders.list.OrderListItemIdentifier
import com.cataloghub.android.ui.orders.list.OrderListItemUIType
import com.cataloghub.android.ui.orders.list.OrderListRepository
import com.cataloghub.android.ui.orders.list.OrderListViewModel
import com.cataloghub.android.ui.orders.list.OrderListViewModel.Companion.BULK_UPDATE_COUNT_LIMIT
import com.cataloghub.android.ui.orders.list.OrderListViewModel.OrderListEvent
import com.cataloghub.android.ui.orders.list.OrderListViewModel.OrderListEvent.OnAddingProductViaScanningFailed
import com.cataloghub.android.ui.orders.list.OrderListViewModel.OrderListEvent.ShowErrorSnack
import com.cataloghub.android.ui.orders.list.ShouldUpdateOrdersList
import com.cataloghub.android.util.getOrAwaitValue
import com.cataloghub.android.util.observeForTesting
...
import com.cataloghub.android.widgets.WCEmptyView.EmptyViewType.NETWORK_ERROR
import com.cataloghub.android.widgets.WCEmptyView.EmptyViewType.NETWORK_OFFLINE
import com.cataloghub.android.widgets.WCEmptyView.EmptyViewType.ORDER_LIST
import com.cataloghub.android.widgets.WCEmptyView.EmptyViewType.ORDER_LIST_CREATE_TEST_ORDER
import com.cataloghub.android.widgets.WCEmptyView.EmptyViewType.ORDER_LIST_LOADING
import com.cataloghub.android.widgets.WCEmptyView.EmptyViewType.SEARCH_RESULTS
...
class OrderListViewModelTest : BaseUnitTest() {
     ...
     * message being emitted via a [com.cataloghub.android.viewmodel.MultiLiveEvent.Event] and the
