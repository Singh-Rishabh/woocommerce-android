package com.cataloghub.android.ui.subscriptions
...
import com.cataloghub.android.ui.products.subscriptions.ProductSubscriptionFreeTrialFragmentArgs
import com.cataloghub.android.ui.products.subscriptions.ProductSubscriptionFreeTrialViewModel
...
class ProductSubscriptionFreeTrialViewModelTest : BaseUnitTest() {
    ...
    private val savedStateHandle: SavedStateHandle = ProductSubscriptionFreeTrialFragmentArgs(
        com.cataloghub.android.ui.products.ProductHelper.getDefaultSubscriptionDetails().copy(
            length = 10
        )
    ).toSavedStateHandle()
